...
<div class="col-md-9">
    <div class="card-header bg-primary">
      <h3 class="card-title ">Allocation per UACS (SAA)</h3>
      <h5></h5>
    </div>
    <!-- /.card-header -->
    <div class="card">       
          ...
          <tbody>
           @foreach ($Allocations as $Allocation)
            <tr>
              ...
              @include('financial-management.planning.allocationuacs.saa.delete') 
  ...
  @include('financial-management.planning.allocationuacs.saa.realignment')

  @include('financial-management.planning.allocationuacs.saa.create')
...
$('#papid').on('change',function () {
  ...
  $.ajax({
      url: '{{ route('fmplanning.getRemBalAllocUACSSAA') }}?papid='+papid,
      type: 'GET',
...
$('#papoffice1').on('change', function () {
  ...
  document.getElementById('rem_bal').value = '';
  $.ajax({
      url: '{{ route('fmplanning.getRemBalAllocUACSyearSAA') }}?papid='+papid+'&papoffice='+papoffice+'&expense_class='+expense_class,
      type: 'GET',
...
$('#year').on('change', function () {
  ...
  document.getElementById('rem_bal').value = '';
  $.ajax({
      url: '{{ route('fmplanning.getRemBalyearAllocUACSSAA') }}?papid='+papid+'&year='+year+'&papoffice='+papoffice+'&expense_class='+expense_class,
      type: 'GET',
...
$('#papidrealign1').on('change', function () {
  ...
  $.ajax({
      url: '{{ route('fmplanning.getRemBalrealignyearSAA') }}?papid='+papid,
      type: 'GET',
...
$('#expense_class_realign').on('change', function () {
  ...
  document.getElementById('rem_balrealign1').value = '';
  $.ajax({
      url: '{{ route('fmplanning.getRemBalrealignyexpenseSAA') }}?papid='+papid+'&expense_class='+expense_class,
      type: 'GET',
...
$('#papoffice').on('change', function () {
  ...
  document.getElementById('rem_balrealign1').value = '';
  $.ajax({
      url: '{{ route('fmplanning.getRemBalrealignofficeSAA') }}?papid='+papid+'&papoffice='+papoffice+'&expense_class='+expense_class,
      type: 'GET',
...
$('#yearrealign1').on('change', function () {
  ...
  $('#office1').append('<option value="">-- Fetching Office --</option>');
  $.ajax({
      url: '{{ route('fmplanning.getRemBalrealign_yearSAA') }}?papid='+papid+'&year='+year+'&papoffice='+papoffice+'&expense_class='+expense_class,
      type: 'GET',
...
$('#uacsidrealign1').on('change', function () {
  ...
  // $('#office1').append('<option value="">-- Fetching Office --</option>');
  $.ajax({
      url: '{{ route('fmplanning.getRemBalrealignbalSAA') }}?allocuacsid='+allocuacsid+'&year='+year+'&papid='+papid+'&expense_class='+expense_class+'&office='+papoffice,
      type: 'GET',
...
$('#office1').on('change', function () {
  ...
  console.log(office);
  $.ajax({
      url: '{{ route('fmplanning.getRemBalrealignbalOfficeSAA') }}?allocuacsid='+allocuacsid+'&year='+year+'&papid='+papid+'&office='+office,
      type: 'GET',
