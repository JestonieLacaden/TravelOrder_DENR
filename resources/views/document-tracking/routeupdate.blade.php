<div class="modal fade" id="update-route-modal-xl{{ $Route->id }}" >
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
         ...
         <form  method="POST" action="{{ route('route.update',[$Route->id]) }}" enctype="multipart/form-data">
         
          {{ csrf_field() }}
          @method('PUT')
          <div class="modal-body">
      
              <input name="documentid" id="documentid"  hidden readonly class="form-control" type="text" value="{{ $Document->PDN }}" oninput="this.value = this.value.toUpperCase()">
