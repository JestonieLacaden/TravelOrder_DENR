<div class="modal fade" id="accept-signature-modal-lg{{ $Route->Voucher->id }}" >
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form  method="POST" action="{{ route('fm.signatureaccept',[$Route->Voucher->id ])}}" enctype="multipart/form-data">
