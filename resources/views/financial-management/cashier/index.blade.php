            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Cashier Section</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-md-3">
                            ...
                            <div class="card-body p-0">
                                <ul class="nav nav-pills flex-column">
                                    <li class="nav-item active">
                                        <a href="{{ route('fmcashier.incoming') }}" class="nav-link">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a href="{{ route('fmcashier.processing') }}" class="nav-link">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('fmcashier.outgoing') }}" class="nav-link">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a href="{{ route('fmcashier.rejected') }}" class="nav-link">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <ul class="nav nav-pills flex-column">
                                    <li class="nav-item active">
                                        <a href="{{ route('fmcashier.accountname') }}" class="nav-link">
                                            Account Name(s) / Payee(s)
                                            @if($Count['6'] != 0)
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a href="{{ route('fmcashier.accountnumber') }}" class="nav-link">
                                            Account Number(s)
                                            @if($Count['7'] != 0)
