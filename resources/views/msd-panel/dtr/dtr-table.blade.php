...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Print Daily Time Record</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              @endcan
              {{-- <button type="button" class="btn btn-default ml-1" data-toggle="modal" data-target="#new-leave-modal-lg"  data-backdrop="static" data-keyboard="false">
            ...
            <div class="card-header">
                ...
                <div class="row invoice-info mb-2">
                    ...
                    <div class="col-sm-10 invoice-col">
                    {{ $Employee->office->office . " - " . $Employee->section->section . " - " . $Employee->unit->unit }}
                    </div>
                </div>
