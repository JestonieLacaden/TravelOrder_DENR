        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            @can('create', \App\Models\Event::class)
              <button type="button" class="btn btn-default" data-toggle="modal" data-target="#new-event-modal-lg"  data-backdrop="static" data-keyboard="false">
...
@include('msd-panel.event-panel.event.create')
