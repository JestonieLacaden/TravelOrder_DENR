        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          @foreach ($Routes as $Route)
            ...
            <tr>
              ...
              @include('financial-management.records.incoming.accept')
              @include('financial-management.records.incoming.reject')
              @include('financial-management.signatory.incoming.signature')
              {{-- @include('financial-management.acceptbyada') --}}
