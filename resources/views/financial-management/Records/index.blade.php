      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Records Section</li>
          </ol>
        </div>
      </div>
              ...
              <div class="card-body p-0">
                <ul class="nav nav-pills flex-column">
                  <li class="nav-item active">       
                    <a href="{{ route('fmrecords.incoming') }}" class="nav-link">
                  ...
                  <li class="nav-item">
                    ...
                    <a href="{{ route('fmrecords.processing') }}" class="nav-link">
                  ...
                  <li class="nav-item">        
                    <a href="{{ route('fmrecords.outgoing') }}" class="nav-link">
                  ...
                  <li class="nav-item">
                    ...
                    <a href="{{ route('fmrecords.rejected') }}" class="nav-link">
                  ...
                  <li class="nav-item">
                    ...
                    <a href="{{ route('fmrecords.pending') }}" class="nav-link">
                      <i class="fas fa-hourglass"></i> Pending Voucher(s)
                      @if($Count['8'] != 0)
                      <span class="badge bg-danger float-right">{{ $Count['8'] }}</span>
                      @endif
                    </a>
                  </li>
                </ul>
