...
<div class="col-md-9">
    <div class="card-header bg-primary">
      <h3 class="card-title ">Allocation per Activity (GAA)</h3>
      <h5></h5>
    </div>
    <!-- /.card-header -->
    <div class="card">       
      ...
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <th  class="text-center">Office </th>
            <th  class="text-center">Activity sss</th>
          ...
          <tbody>
           @foreach ($Allocations as $Allocation)
            <tr>
              ...
              @include('financial-management.planning.allocation.delete') 
            @endforeach          
          </tbody>
        </table>
      </div>
  ...
  @include('financial-management.planning.allocation.create')
...
<script type="text/javascript">
  $(document).ready(function () {
      $('#papid').on('change', function () {
          ...
          $.ajax({
              url: '{{ route('fmplanning.getActivityAllocation') }}?papid='+papid,
              type: 'GET',
...
$('#papoffice').on('change', function () {
  ...
  document.getElementById('rem_bal').value = '';
  $.ajax({
      url: '{{ route('fmplanning.getRemBalAllocPAPyear') }}?papid='+papid+'&papoffice='+papoffice+'&expense_class='+expense_class,
      type: 'GET',
...
$('#year').on('change', function () {
  ...
  document.getElementById('rem_bal').value = '';
  $.ajax({
      url: '{{ route('fmplanning.getRemBalyearAllocPAP') }}?papid='+papid+'&year='+year+'&papoffice='+papoffice+'&expense_class='+expense_class,
      type: 'GET',
