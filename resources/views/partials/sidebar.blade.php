        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                {{-- @can('acceptemployee', \App\Models\Leave::class)
                <li class="nav-item">
                    <a href="{{ route('travel-order-request') }}" class="nav-link">
                        <i class="nav-icon fas fa-users"></i>
                        <p>
                            Employee Request(s)
                            @if(isset($Count) && is_array($Count) && count($Count) >= 2)
                            <span class="right badge badge-info">{{ $Count[1] }}</span>
                            @endif
                        </p>
                    </a>
                </li>
            ...
            {{ Request::is('msd-management/dtr-signatory') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link {{ Request::is('data-management/employee/*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href=""
                                class="nav-link {{ Request::is('financial-management/allocation*') ? 'active' : '' }}">
