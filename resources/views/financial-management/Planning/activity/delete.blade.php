<div class="modal fade" id="delete-activity-modal-lg{{ $Activity->id }}" >
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form  method="POST" action="{{ route('fmplanning.activitydelete',[$Activity->id ])}}" enctype="multipart/form-data">
          {{ csrf_field() }}
            <input type="text" hidden  name="activity" id="activity" value="{{$Activity->activity }}">
          <div class="modal-body">
             You sure you want to Delete Activity: <b>{{ $Activity->activity }}<b>?</div> 
