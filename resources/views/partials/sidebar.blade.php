        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item  ">
                    <a href="{{ route('userleave.index') }}"
                        class="nav-link {{ Request::is('leave-management/*') ? 'active' : ''}} {{ Request::is('leave-management') ? 'active' : ''}}">
                ...
                <li class="nav-item  ">
                    <a href="{{ route('usertravelorder.index') }}"
                        class="nav-link {{ Request::is('leave-management/*') ? 'active' : ''}} {{ Request::is('travel-order-management') ? 'active' : ''}}">
                ...
                @can ('viewDTRIndex', \App\Models\Dtr_History::class)
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('employee.index') }}"
                                    class="nav-link  {{ Request::is('msd-management/encoder/employee') ? 'active' : '' }}">
                                    <p class="ml-4 p-2">Employee<span
                                            class="badge badge-info right">{{ $EmployeeCount }}</span></p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('leave-management.index') }}"
                            class="nav-link  {{ Request::is('msd-management/encoder/leave-management') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('travel-order.index') }}"
                            class="nav-link  {{ Request::is('msd-management/encoder/travel-order') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('event.index') }}"
                    class="nav-link {{ Request::is('msd-management/event') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="#"
                            class="nav-link  {{ Request::is('msd-management/settings/leave-settings/*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('leave-mgmt.index') }}"
                                    class="nav-link  {{ Request::is('msd-management/settings/leave-settings/leave-mgmt') ? 'active' : '' }}">

                                    <p class="ml-4 p-2">Leave Credit<span class="badge badge-info right"></span></p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('leave-signatory.index') }}"
                                    class="nav-link  {{ Request::is('msd-management/settings/leave-settings/leave-signatory') ? 'active' : '' }}">

                                    <p class="ml-4 p-2">Leave Signatory<span class="badge badge-info right"></span></p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('set-leave-signatory.index') }}"
                                    class="nav-link  {{ Request::is('msd-management/settings/leave-settings/set-leave-signatory') ? 'active' : '' }}">

                                    <p class="ml-4 p-2">Set Signatory<span class="badge badge-info right"></span></p>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="#"
                            class="nav-link  {{ Request::is('msd-management/settings/travel-order-settings/*') ? 'active' : '' }}">
                            <i class="far fas fa-users nav-icon"></i>
                            <p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                ...
                                <a href="{{ route('travel-order-signatory.index') }} "
                                    class="nav-link  {{ Request::is('msd-management/settings/travel-order-settings/travel-order-signatory') ? 'active' : '' }}">

                                    <p class="ml-4 p-2">T.O. Signatory<span class="badge badge-info right"></span></p>
                                </a>
                            </li>
                            <li class="nav-item">

                                <a href="{{ route('set-travel-order-signatory.index') }}"
                                    class="nav-link  {{ Request::is('msd-management/settings/travel-order-settings/set-travel-order-signatory') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('user.index') }}"
                                    class="nav-link  {{ Request::is('data-management/user/user') ? 'active' : '' }}">

                                    <p class="ml-4 p-2">User<span class="badge badge-info right">{{ $UserCount }}</span>
                                    </p>
                                </a>
                            </li>
                        </ul>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('role.index') }}"
                                    class="nav-link  {{ Request::is('data-management/user/role') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                ...
                                <a href="{{ route('office.index') }}"
                                    class="nav-link {{ Request::is('data-management/employee/office') ? 'active' : '' }}">
                                    <p class="ml-4 p-2">Office<span
                                            class="badge badge-info right">{{ $OfficeCount }}</span></p>
                                    </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('section.index') }}"
                                    class="nav-link {{ Request::is('data-management/employee/section') ? 'active' : '' }}">
                                    <p class="ml-4 p-2">Section<span
                                            class="badge badge-info right">{{ $SectionCount }}</span></p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('unit.index') }}"
                                    class="nav-link {{ Request::is('data-management/employee/unit') ? 'active' : '' }}">
                                    <p class="ml-4 p-2">Unit <span
                                            class="badge badge-info right">{{ $UnitCount }}</span></p>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            @can('viewany', \App\Models\FinancialManagement::class)
            <li class="nav-item">
                <a href="#" class="nav-link  {{ Request::is('financial-management/allocation*') ? 'active' : '' }} {{ Request::is('financial-management/financial_tracking') ? 'active' : '' }} {{ Request::is('financial-management/realignment_report') ? 'active' : '' }}">
                    <p>
                        Report
                        <i class="right fas fa-angle-left"></i>
                    </p>
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('financial-management.AllocationPayeereport') }}"
                                class="nav-link {{ 'financial-management/allocation-payee-report' == request()->path() ? 'active' : ''}}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('financial-management.Allocationreport') }}"
                                class="nav-link {{ 'financial-management/allocation-report' == request()->path() ? 'active' : ''}}">
                                <i class="nav-icon fas fa-file"></i>
                                <p>
                                    Per Activity Report
                                </p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('financial-management.AllocationUACSreport') }}"
                                class="nav-link {{ 'financial-management/allocation-uacs-report' == request()->path() ? 'active' : ''}}">
                                <i class="nav-icon fas fa-file"></i>
                                <p>
                                    Per UACS Report
                                </p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('financial-management.AllocationPAPreport') }}"
                                class="nav-link {{ 'financial-management/allocation-pap-report' == request()->path() ? 'active' : ''}}">
                                <i class="nav-icon fas fa-file"></i>
                                <p>
                                    Per PAP Report
                                </p>
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item ">
                        <a href="{{ route('financial-management.RealignmentReport') }}"
                            class="nav-link {{ 'financial-management/realignment_report' == request()->path() ? 'active' : ''}}">
                            <i class="nav-icon fas fa-file"></i>
                            <p>
                                Realignment Report
                            </p>
