<div class="modal fade" id="route-bybatch-modal-xl{{ $Route->voucher->id }}" >
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
         ...
         <form  method="POST" action="{{ route('fmroutebyada.store') }}" enctype="multipart/form-data">
          ...
          <div class="modal-body">
              ...
              <div class="form-group row">
                <label  class="col-sm-2" for="batchid">LDDAP / ADA Number : </label>
                <div class=" col-sm-10">
                <input name="batchid" id="batchid" class="form-control" type="text" value="{{  $Ada[1] }}" oninput="this.value = this.value.toUpperCase()" readonly>
                @error('batchid')
                <p class="text-danger text-xs mt-1">{{$message}}</p>
                @enderror
                </div>
