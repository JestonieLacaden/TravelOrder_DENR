<div class="modal fade" id="add-charging-modal-lg{{ $Route->Voucher->id }}" >
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Add Charging (GAA)</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  
        <form  method="POST" action="  {{ route('fmplanning.charging',[$Route->Voucher->id ])}}" enctype="multipart/form-data">
   ...
   --}}
          ...
          <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="Activity">Activity : <span class="text-danger">*</span> </label>
            <div class="col-sm-10">
              <select name="activityid" id="activity" class="form-control select2" style="width: 100%;">
          ...
          <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="activityoffice">Office : <span class="text-danger">*</span> </label>
            <div class="col-sm-10">
              <select name="activityoffice" id="activityoffice" class="form-control select2" style="width: 100%;">
          ...
          <div class="form-group row">
            ...
            <div class=" col-sm-10">
            <input name="rem_bal" id="rem_bal" class="form-control" type="string" value="{{old('amount')}}" oninput="this.value = this.value.toUpperCase()" readonly>
            @error('rem_bal')
            <p class="text-danger text-xs mt-1">{{$message}}</p>
            @enderror
            </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select name="uacsid"  id="uacs" class="form-control select2" style="width: 100%;">
        ...
        <div class="form-group row">
          <label class="col-sm-2 col-form-label" for="year_uacs">Year : <span class="text-danger">*</span> </label>
          <div class="col-sm-10">
            <select name="year_uacs" id="year_uacs" class="form-control select2" style="width: 100%;">
              <option value="" disabled selected>-- Choose Year --</option>
        ...
        <div class="form-group row">
          <label class="col-sm-2 col-form-label" for="uacsoffice">Office : <span class="text-danger">*</span> </label>
          <div class="col-sm-10">
            <select name="uacsoffice" id="uacsoffice" class="form-control select2" style="width: 100%;">
              <option value="" disabled selected>-- Choose Office --</option>
        ...
        <div class="form-group row">
          <label class="col-sm-2" for="rem_baluacs">Remaining Balance :<span class="text-danger">*</span></label>
          <div class=" col-sm-10">
          <input name="rem_baluacs" id="rem_baluacs" class="form-control" type="string" value="{{old('amount')}}" oninput="this.value = this.value.toUpperCase()" readonly>
          @error('rem_baluacs')
          <p class="text-danger text-xs mt-1">{{$message}}</p>
          @enderror
          </div>
