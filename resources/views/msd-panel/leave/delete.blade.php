      ...
      <div class="modal-content">
        ...
        <form  method="POST" action="{{ route('leave-management.destroy',[ $Leave->id])}}" enctype="multipart/form-data">
          ...
          <div class="modal-body">
             You sure you want to delete <i class="text-bold">{{ $Leave->leave_type->leave_type }} </i>of  <b>{{ $Leave->employee->firstname . ' ' . $Leave->employee->middlename . ' ' . $Leave->employee->lastname }}<b>?</div>
