          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                ...
                <button type="button" title="Re-Route Document" class="btn btn-success" data-toggle="modal" data-target="#route-document-modal-xl{{ $Route->document->id }}"  data-backdrop="static" data-keyboard="false">
