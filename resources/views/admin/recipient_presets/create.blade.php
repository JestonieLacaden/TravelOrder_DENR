...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Recipient Preset</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">New Recipient Preset</h3>
                </div>
                <form action="{{ route('admin.recipient-presets.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="e.g., Juan Dela Cruz" required>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('office') is-invalid @enderror" id="office" name="office" value="{{ old('office') }}" placeholder="e.g., CENRO San Jose" required>
                            @error('office')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('position') is-invalid @enderror" id="position" name="position" value="{{ old('position') }}" placeholder="e.g., OIC">
                            @error('position')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
