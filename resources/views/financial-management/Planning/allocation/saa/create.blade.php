<div class="modal fade" id="create-allocation-modal-lg" >
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Create Allocation per Activity (SAA)</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
    {{--  --}}
        <form  method="POST" action="{{ route('fmplanning.allocationcreateSAA')}}" enctype="multipart/form-data">
   ...
   --}}
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
              <label class="col-sm-2 col-form-label" for="activityid">Activity :<span class="text-danger">*</span> </label>
              <div class="col-sm-10">
                <select name="activityid" id="activityid_allocation" class="form-control select2" style="width: 100%;">
