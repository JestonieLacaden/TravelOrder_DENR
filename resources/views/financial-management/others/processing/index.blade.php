@extends('financial-management.others.index')
          ...
          @foreach ($Routes as $Route)
            <tr>
              ...
              <td class="text-center">
                ...
                <button type="button" title="Mark as Close" class="btn btn-danger" data-toggle="modal" data-target="#close-voucher-modal-lg{{ $Route->voucher->id }}"  data-backdrop="static" data-keyboard="false">
                  <i class="fas fa-times"></i>
                </button>
              </td>
              </tr>
          @include('financial-management.others.processing.delete') 
