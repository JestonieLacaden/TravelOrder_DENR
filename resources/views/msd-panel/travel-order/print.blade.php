...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <div class="mb-4">
        <div>
            This is to certify that the travel is necessary and is connected with the functions of the official/employee of the Div/Sec/Unit.
        </div>
    </div>
        ...
        <div class=" invoice-info mb-2 ml-2 col-5">
            <div class="mb-2 text-center">
                <div class="d-flex align-items-center flex-column">
                    <img src="{{ asset('images/dummySign.png') }}" class="brand-image" style="height: 50px" draggable="false" oncontextmenu="return false;" onmousedown="return false;" onselectstart="return false;" />
    ...
    <div class="mt-4">
            <div class="mb-2 text-center">
                <div>
                    <strong class="border-bottom"> {{$Employee->firstname .' '. $Employee->middlename .' '. $Employee->lastname }} </strong>
                </div>
                <div class="px-2">
                    Official/Employee
