@extends('financial-management.signatory.index')
...
<div class="col-md-9">
          ...
          @foreach ($Routes as $Route)
            ...
            <tr>
              ...
              <td class="text-center">
                ...
                <button type="button" title="Approve" class="btn btn-warning" data-toggle="modal" data-target="#approve-voucher-modal-xl{{ $Route->voucher->id }}"  data-backdrop="static" data-keyboard="false">
  ...
  @foreach ($Routes as $Route)
  @include('financial-management.signatory.processing.approve')
