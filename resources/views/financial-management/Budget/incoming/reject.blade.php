<div class="modal fade" id="reject-voucher-modal-lg{{ $Route->Voucher->id  }}" >
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form  method="POST" action="{{ route('fm.reject',[$Route->sequenceid ])}}" enctype="multipart/form-data">
          {{ csrf_field() }}
            <input type="text" hidden  name="sequenceid" id="sequenceid" value="{{$Route->sequenceid}}">
          <div class="modal-body">
             You sure you want to Reject Sequence ID: <b>{{ $Route->sequenceid }}<b>?</div>
