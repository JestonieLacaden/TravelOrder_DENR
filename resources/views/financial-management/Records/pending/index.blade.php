@extends('financial-management.records.index')

@section('fm-content')

<div class="col-md-9">
    <div class="card-header bg-primary">
      <h3 class="card-title ">Pending Voucher(s)  </h3>
      <h5></h5>
    </div>
    <!-- /.card-header -->
    <div class="card">       
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          @foreach ($Routes as $Route)
            <tr>
              ...
              <td> <a href="{{ route('financial-management.view',[$Route->voucher->id]) }}"> {{ $Route->sequenceid }}</a></td>
